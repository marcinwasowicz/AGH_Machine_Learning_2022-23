...
class _ResNet_Custom_Impl(nn.Module):
    def __init__(
        self,
        block,
        layers,
...
def _resnet18_scaled():
    model = _ResNet_Custom_Impl(BasicBlock, [1, 1, 1, 1])
    return model


class ResNet18ScaledClassifier(nn.Module):
    def __init__(self, num_classes) -> None:
        super().__init__()
        self.base = _resnet18_scaled()
